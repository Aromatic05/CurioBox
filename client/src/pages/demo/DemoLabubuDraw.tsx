...
const demoBoxes = [
    {
        ...
        items: [
            {
                name: "Labubu-稀有款",
                image: "https://img.popmart.com.cn/item/labubu-rare.jpg",
                rarity: "超稀有",
            },
            {
                name: "Labubu-普通款",
                image: "https://img.popmart.com.cn/item/labubu-normal.jpg",
                rarity: "普通",
            },
            {
                name: "Labubu-隐藏款",
                image: "https://img.popmart.com.cn/item/labubu-secret.jpg",
                rarity: "隐藏",
            },
        ],
    },
...
const OpenResultDialog: React.FC<{ item: any; onClose: () => void }> = ({
    item,
    onClose,
}) => {
    if (!item) return null;
